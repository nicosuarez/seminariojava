 ...
 * @see ar.com.infocompany.entities.Field
...
public class FieldHome {
	...
	public Field merge(Field detachedInstance) {
		...
		try {
			Field result = (Field) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Field findById(java.lang.Integer id) {
		log.debug("getting Field instance with id: " + id);
		try {
			Field instance = (Field) sessionFactory.getCurrentSession().get(
					"ar.com.infocompany.entities.Field", id);
			if (instance == null) {
	...
	public List findByExample(Field instance) {
		log.debug("finding Field instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"ar.com.infocompany.entities.Field").add(
